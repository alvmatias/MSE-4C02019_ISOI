...
typedef struct 
{
    ...
    uint32_t        priority;                       /**< Prioridad de la tarea */
        ...
        tick_t          ticksToWait;                /**< Ticks a esperar en caso de ejecucion de taskDelay() */
    #endif
...
typedef struct
{
    ...
    tick_t              tickCount;                                         /**< Tick del sistema */
...
#if ( OS_USE_TASK_DELAY == 1 )
    /**
    * @fn void taskDelay(tick_t ticksToDelay)
